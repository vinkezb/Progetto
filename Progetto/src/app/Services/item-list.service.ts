...
export class ItemListService {
  ...
  itemList: ItemList[]=[
    ...
    {itemId: 4, itemImage: "michael_kors.jpg", itemName: "Michaell Kors", itemDescription: "Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. ", isFavorite: true, isHidden: false},
